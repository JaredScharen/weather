$(function() {
  var handleWeatherResponse = function(data) {
    ...
    var markup = "<p>The current weather is " + data.currently.summary + "<p>The 3 day forecast is: " + "<p>Day 1: " + data.daily.data[0].summary + "<p>Day 2: " + data.daily.data[1].summary + "<p>Day 3: " + data.daily.data[2].summary;
